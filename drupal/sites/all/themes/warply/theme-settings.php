 ...
 */
function warply_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['warply_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('warply sample setting'),
  '#default_value' => theme_get_setting('warply_example'),
